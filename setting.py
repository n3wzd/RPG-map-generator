...
def load_ini():
    ...
    param.deco_rate = config.getfloat('MapBasic', 'deco_rate')
    ...
    param.room_freq = config.getfloat('Dungeon', 'room_freq')

    param.wall_probability = config.getfloat('Cave', 'wall_probability')
